    ...
    try {
        if (!previewed) {
            const r = await fetch(routes.post_clock_preview, {
                ...
                body: JSON.stringify({
                    is_hour_black: colour_picker_mode(colour_pickers.hour) === 'black',
                    hour_hs: { h: colour_pickers.hour.h, s: colour_pickers.hour.s, v: colour_pickers.hour.v },
                    is_minute_black: colour_picker_mode(colour_pickers.minute) === 'black',
                    ...
                    is_second_black: colour_picker_mode(colour_pickers.second) === 'black',
